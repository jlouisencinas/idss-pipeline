...
import requests
from utils import extract_zip, extract_report_date, clean_numbers, cleanup_download_folder, upload_to_drive, trigger_app_script
...
WEBAPP_URL = "https://script.google.com/macros/s/AKfycbz3-Dbi4sSJFybBwPSZlkHZQKZC9Qw-GWf36WQ_EMhj5SNUsQSItXg28EavjRlUJ_lp/exec"  # replace with your deployed Web App URL
...
if __name__ == "__main__":
    ...
    if all_dfs:
        ...
        # Trigger Apps Script to update DB
        trigger_app_script(WEBAPP_URL)
        cleanup_download_folder(WORKING_DIR, os.path.basename(consolidated_csv))
    else:
